...
/* USER CODE BEGIN OSWrappers.cpp */
#include <rtthread.h>
...
{
    frame_buffer_sem = rt_sem_create("frame",1,RT_IPC_FLAG_PRIO);
    vsync_q = rt_mq_create("vsync",1,1,RT_IPC_FLAG_PRIO);
}
